    ...
    <>
      <div className={darkMode ? "dark" : "light"}>
        <img
          src={product.image}
          alt=""
          className="h-64 w-full object-cover border-[2px] border-white transition duration-500 group-hover:scale-105 sm:h-72"
        />
        ...
        <div className="relative border border-gray-100 dark:bg-gray-700 bg-white p-6">
          ...
          {cart.includes(product) ? (
            <button
              ...
              aria-label="Remove item from cart" // Accessibility improvement
            >
              Remove From Cart
            </button>
          ) : (
            <button
              ...
              aria-label="Add item to cart" // Accessibility improvement
            >
              Add to Cart
            </button>
          )}
